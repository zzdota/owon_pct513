//part of cool_ui;
import 'owon_screen_util.dart';
import 'dart:core';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';
import 'package:flutter/rendering.dart';
import 'owon_widget_util.dart';
typedef BoolCallback = bool Function();
class OwonPopoverButton extends StatelessWidget{
  final Widget child;
...
class CupertinoPopoverState extends State<CupertinoPopover>  with TickerProviderStateMixin{
  ...
  static const double _arrowHeight = 0.0;
...
class _CupertionPopoverPositionRenderObject extends RenderShiftedBox{
  ...
  Offset calcOffset(Size size){
    ...
    bodyLeft = (ScreenUtil.getInstance().screenWidth - size.width)*0.5;
