...
class OwonNumberPicker extends StatelessWidget {
...
class _NumberPickerDialogControllerState extends State<NumberPickerDialog> {
  ...
  OwonNumberPicker _buildNumberPicker() {
    if (widget.decimalPlaces > 0) {
      return new OwonNumberPicker.decimal(
      ...
      return new OwonNumberPicker.integer(
